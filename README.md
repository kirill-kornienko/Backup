# Домашнее задание к занятию "`Кластеризация и балансировка нагрузки`" - `Корниенко Кирилл`
...
#### Конфигурационный файл haproxy: [haproxy2.cfg](https://github.com/kirill-kornienko/HAProxy/blob/main/img/haproxy2.cfg)
...
![haproxy2](https://github.com/kirill-kornienko/HAProxy/blob/main/img/haproxy2.png)
